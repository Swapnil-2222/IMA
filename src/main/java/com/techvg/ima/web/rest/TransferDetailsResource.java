...
import com.techvg.ima.service.TransferDetailsQueryService;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.TransferDetails}.
 */
@RestController
@RequestMapping("/api")
public class TransferDetailsResource {
    ...
    public ResponseEntity<TransferDetailsDTO> updateTransferDetails(
        ...
        TransferDetailsDTO result = transferDetailsService.update(transferDetailsDTO);
        return ResponseEntity
            .ok()
