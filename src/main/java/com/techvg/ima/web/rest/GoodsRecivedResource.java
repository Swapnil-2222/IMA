...
import com.techvg.ima.service.GoodsRecivedQueryService;
import com.techvg.ima.service.GoodsRecivedService;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.GoodsRecived}.
 */
@RestController
@RequestMapping("/api")
public class GoodsRecivedResource {
    ...
    public ResponseEntity<GoodsRecivedDTO> updateGoodsRecived(
        ...
        GoodsRecivedDTO result = goodsRecivedService.update(goodsRecivedDTO);
        return ResponseEntity
            .ok()
