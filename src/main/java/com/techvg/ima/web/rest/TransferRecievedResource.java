...
import com.techvg.ima.service.TransferRecievedQueryService;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.TransferRecieved}.
 */
@RestController
@RequestMapping("/api")
public class TransferRecievedResource {
    ...
    public ResponseEntity<TransferRecievedDTO> updateTransferRecieved(
        ...
        TransferRecievedDTO result = transferRecievedService.update(transferRecievedDTO);
        return ResponseEntity
            .ok()
