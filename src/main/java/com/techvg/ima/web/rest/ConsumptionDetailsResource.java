...
import com.techvg.ima.service.ConsumptionDetailsQueryService;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.ConsumptionDetails}.
 */
@RestController
@RequestMapping("/api")
public class ConsumptionDetailsResource {
    ...
    public ResponseEntity<ConsumptionDetailsDTO> updateConsumptionDetails(
        ...
        ConsumptionDetailsDTO result = consumptionDetailsService.update(consumptionDetailsDTO);
        return ResponseEntity
            .ok()
