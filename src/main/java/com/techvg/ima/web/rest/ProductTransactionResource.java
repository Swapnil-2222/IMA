...
import com.techvg.ima.service.ProductTransactionQueryService;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.ProductTransaction}.
 */
@RestController
@RequestMapping("/api")
public class ProductTransactionResource {
    ...
    public ResponseEntity<ProductTransactionDTO> updateProductTransaction(
        ...
        ProductTransactionDTO result = productTransactionService.update(productTransactionDTO);
        return ResponseEntity
            .ok()
