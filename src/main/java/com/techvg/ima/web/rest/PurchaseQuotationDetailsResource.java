...
import com.techvg.ima.repository.PurchaseQuotationDetailsRepository;
import com.techvg.ima.service.PurchaseQuotationDetailsQueryService;
import com.techvg.ima.service.PurchaseQuotationDetailsService;
import com.techvg.ima.service.criteria.PurchaseQuotationDetailsCriteria;
import com.techvg.ima.service.dto.PurchaseQuotationDetailsDTO;
import com.techvg.ima.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.techvg.ima.domain.PurchaseQuotationDetails}.
 */
@RestController
@RequestMapping("/api")
public class PurchaseQuotationDetailsResource {
    ...
    public ResponseEntity<PurchaseQuotationDetailsDTO> updatePurchaseQuotationDetails(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, purchaseQuotationDetailsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PurchaseQuotationDetailsDTO> partialUpdatePurchaseQuotationDetails(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, purchaseQuotationDetailsDTO.getId().toString())
        );
    }
