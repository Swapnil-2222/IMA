...
import com.techvg.ima.service.mapper.PurchaseQuotationDetailsMapper;
...
class PurchaseQuotationDetailsResourceIT {
    ...
    void deletePurchaseQuotationDetails() throws Exception {
        ...
        restPurchaseQuotationDetailsMockMvc
            .perform(delete(ENTITY_API_URL_ID, purchaseQuotationDetails.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
