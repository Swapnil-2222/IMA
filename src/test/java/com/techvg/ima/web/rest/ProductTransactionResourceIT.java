...
import com.techvg.ima.domain.enumeration.TransactionType;
import com.techvg.ima.repository.ProductTransactionRepository;
import com.techvg.ima.service.ProductTransactionService;
import com.techvg.ima.service.criteria.ProductTransactionCriteria;
import com.techvg.ima.service.dto.ProductTransactionDTO;
import com.techvg.ima.service.mapper.ProductTransactionMapper;
...
class ProductTransactionResourceIT {
    ...
    void getAllProductTransactionsWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        restProductTransactionMockMvc.perform(get(ENTITY_API_URL + "?eagerload=false")).andExpect(status().isOk());
        verify(productTransactionRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void deleteProductTransaction() throws Exception {
        ...
        restProductTransactionMockMvc
            .perform(delete(ENTITY_API_URL_ID, productTransaction.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
