...
import com.techvg.ima.service.mapper.SecurityUserMapper;
...
class SecurityUserResourceIT {
    ...
    void deleteSecurityUser() throws Exception {
        ...
        restSecurityUserMockMvc
            .perform(delete(ENTITY_API_URL_ID, securityUser.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
