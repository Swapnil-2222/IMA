...
import com.techvg.ima.service.mapper.SecurityPermissionMapper;
...
class SecurityPermissionResourceIT {
    ...
    void deleteSecurityPermission() throws Exception {
        ...
        restSecurityPermissionMockMvc
            .perform(delete(ENTITY_API_URL_ID, securityPermission.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
