...
import com.techvg.ima.service.mapper.SecurityRoleMapper;
...
class SecurityRoleResourceIT {
    ...
    void deleteSecurityRole() throws Exception {
        ...
        restSecurityRoleMockMvc
            .perform(delete(ENTITY_API_URL_ID, securityRole.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
