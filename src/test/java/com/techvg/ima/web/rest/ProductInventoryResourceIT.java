...
import com.techvg.ima.repository.ProductInventoryRepository;
import com.techvg.ima.service.ProductInventoryService;
import com.techvg.ima.service.criteria.ProductInventoryCriteria;
import com.techvg.ima.service.dto.ProductInventoryDTO;
import com.techvg.ima.service.mapper.ProductInventoryMapper;
...
class ProductInventoryResourceIT {
    ...
    void getAllProductInventoriesWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        restProductInventoryMockMvc.perform(get(ENTITY_API_URL + "?eagerload=false")).andExpect(status().isOk());
        verify(productInventoryRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void deleteProductInventory() throws Exception {
        ...
        restProductInventoryMockMvc
            .perform(delete(ENTITY_API_URL_ID, productInventory.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
