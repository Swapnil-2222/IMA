...
import com.techvg.ima.domain.enumeration.OrderType;
import com.techvg.ima.domain.enumeration.Status;
import com.techvg.ima.repository.PurchaseQuotationRepository;
import com.techvg.ima.service.PurchaseQuotationService;
import com.techvg.ima.service.criteria.PurchaseQuotationCriteria;
import com.techvg.ima.service.dto.PurchaseQuotationDTO;
import com.techvg.ima.service.mapper.PurchaseQuotationMapper;
...
class PurchaseQuotationResourceIT {
    ...
    void deletePurchaseQuotation() throws Exception {
        ...
        restPurchaseQuotationMockMvc
            .perform(delete(ENTITY_API_URL_ID, purchaseQuotation.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
